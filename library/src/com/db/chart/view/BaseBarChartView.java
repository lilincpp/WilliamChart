...
public abstract class BaseBarChartView extends ChartView {
    ...
    private static final String TAG = "BaseBarChartView";

    void drawTextForBarEnd(Canvas canvas, float text, float startX, float startY, float textSize, float padding, int color) {
